...
public class Personne{
    ...
    public Personne getPersonne(Connection c, Date date, String nom)throws SQLException{
        ...
        String sql = "select id ,nom,dates,budget, traitement from personne where dates = '"+date+"' and nom ='"+nom+"'";
        ...
        while(rs.next()){
            ...
            double budgets = rs.getDouble("budget");
            int tr = rs.getInt("traitement");
            personne = new Personne(id,noms,budgets,dates,tr);
        }
        return personne;
    }
}